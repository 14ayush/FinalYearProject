...
def avg_data_2015():
    temp_i=0
    average=[]
    for rows in pd.read_csv('C:\\Users\\aayus\\AQI Final year\\AQI\\aqi2015.csv',chunksize=24):
        add_var=0
        avg=0.0
        data=[]
...
def avg_data_2016():
    temp_i=0
    average=[]
    for rows in pd.read_csv('C:\\Users\\aayus\\AQI Final year\\AQI\\aqi2016.csv',chunksize=24):
        add_var=0
        avg=0.0
        data=[]
        df=pd.DataFrame(data=rows)
...
def avg_data_2017():
    temp_i=0
    average=[]
    for rows in pd.read_csv('C:\\Users\\aayus\\AQI Final year\\AQI\\aqi2017.csv',chunksize=24):
        add_var=0
        avg=0.0
        data=[]
        df=pd.DataFrame(data=rows)
...
def avg_data_2018():
    temp_i=0
    average=[]
    for rows in pd.read_csv('C:\\Users\\aayus\\AQI Final year\\AQI\\aqi2018.csv',chunksize=24):
        add_var=0
        avg=0.0
        data=[]
        df=pd.DataFrame(data=rows)
...
def avg_data_2019():
    temp_i=0
    average=[]
    for rows in pd.read_csv('C:\\Users\\aayus\\AQI Final year\\AQI\\aqi2019.csv',chunksize=24):
        add_var=0
        avg=0.0
        data=[]
        df=pd.DataFrame(data=rows)
...
def avg_data_2020():
    temp_i=0
    average=[]
    for rows in pd.read_csv('C:\\Users\\aayus\\AQI Final year\\AQI\\aqi2020.csv',chunksize=24):
        add_var=0
        avg=0.0
        data=[]
        df=pd.DataFrame(data=rows)
...
def avg_data_2021():
    temp_i=0
    average=[]
    for rows in pd.read_csv('C:\\Users\\aayus\\AQI Final year\\AQI\\aqi2021.csv',chunksize=24):
        add_var=0
        avg=0.0
        data=[]
        df=pd.DataFrame(data=rows)
...
def avg_data_2022():
    temp_i=0
    average=[]
    for rows in pd.read_csv('C:\\Users\\aayus\\AQI Final year\\AQI\\aqi2022.csv',chunksize=24):
        add_var=0
        avg=0.0
        data=[]
        df=pd.DataFrame(data=rows)
...
if __name__=="__main__":
    ...
    plt.plot(range(1,366), lst2015, label="2015 data")  # 365 days in a year
